...
pub(crate) const DEFAULT_AGENT_MAX_THREADS: Option<usize> = Some(128);
pub(crate) const DEFAULT_MULTI_AGENT_V2_MAX_CONCURRENT_THREADS_PER_SESSION: usize = 128;
...
pub(crate) const DEFAULT_AGENT_MAX_DEPTH: i32 = 128;
